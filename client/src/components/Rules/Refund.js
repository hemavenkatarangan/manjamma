                    ...
                    <div className="row" style={{ marginTop: '100px' }}>
                        <div className="text-container" style={{ marginTop: '45px' }}>
                            ...
                            <ol>
                                <li>
                                    <p className="" style={{ fontFamily: 'Poppins', textAlign: 'justify', color: 'black', fontSize: '16px' }}>
                                    75% refund for cancellations 30 days prior to the start date of the program.
                                    </p>
                                </li>
                                <li>
                                    <p className="" style={{ fontFamily: 'Poppins', textAlign: 'justify', color: 'black', fontSize: '16px' }}>
                                    No refunds for cancellations 15 days before the start date of the course.
                                    </p>
                                </li>
                                <li>
                                    <p className="" style={{ fontFamily: 'Poppins', textAlign: 'justify', color: 'black', fontSize: '16px' }}>
                                    There will be no refunds for a no-show or any withdrawal from the course once it has started. 
                                    </p>
                                </li>
                            </ol>
                            <p className="" style={{ fontFamily: 'Poppins', textAlign: 'justify', color: 'black', fontSize: '16px' }}>
