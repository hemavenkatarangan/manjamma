function YogaPhilosophy() {
    return (
        <>
             <div className="row" style={{background: "url(../images/header-background.png) center center no-repeat"}}>
                    <div className="col-lg-5" style={{textAlign:'center', marginTop: '65px'}}>
                       <img src="../images/ouryogaphil.png" alt="alternative" />
                    </div>
