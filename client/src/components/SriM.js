                ...
                <div className="container">
                    <div className="row">
                        <div className="col-xl-10 offset-xl-1" style={{ marginTop: '20px'}} >
                            ...
                            <p style={{ textAlign: 'center', fontWeight:'bold', padding:'90px' }}>
                                “Quality, not quantity. Spiritual evolution is individual and cannot be a mass phenomenon. No meditation-technique franchises can do much good. Each individual is special. No poster blitz and poster wars when your work starts.”
                            </p>
                            <p style={{ textAlign: 'justify', fontFamily: 'Poppins' }}>
                            ...
                            <p style={{ textAlign: 'justify', fontFamily: 'Poppins' }}>
                                In 2011, he wrote his memoir <strong>“Apprenticed to a Himalayan Master – A Yogi’s Autobiography“</strong>, which became an instant bestseller. A sequel, <strong>“The Journey Continues”</strong> was published in 2017. Sri M has also authored several texts on the Upanishads, on Meditation, and a novel <strong>“Shunya”</strong>. His book <strong>‘On Meditation – Finding infinite bliss and power within,’</strong> was published by Penguin India. Two books were released in 2020 – <strong>‘Homecoming and Other Short Stories’</strong>, a collection of short stories again by Penguin and a translation and commentary on Patanjali’s Yoga Sutras – titled <strong>‘Yoga also for the Godless’</strong> published by Westland Publications. All his books have been translated into many Indian languages.
                            </p>
                            <p style={{ textAlign: 'justify', fontFamily: 'Poppins' }}>
                            ...
                            <p style={{ textAlign: 'justify', fontFamily: 'Poppins' }}>
                                Among the many awards and honours he has received for his contribution to society, Sri M was conferred with the <strong>Padma Bhushan in January 2020</strong>,one of the highest civilian awards of India, for distinguished service of high order in spirituality.
                            </p>
                        </div>
                    </div>
                </div>
