...
var PaymentSchema = new Schema(
    {
        ...
        status: { type: String, required: true, enum: ['YetToReview', 'InReview', 'onHold', 'Waitlist', 'declined', 'approved', 'ongoing', 'completed', 'cancelled'], default: '' },
